...
<x-app-layout>
    <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
        <div class="space-y-6 sm:px-6 lg:col-span-12 lg:px-0">
            <form action="{{ route('plans.update', $plan) }}" method="POST" enctype="multipart/form-data" x-data="{
                featuresInput: '',
                        ...
                        <div class="mt-5 space-y-6 md:mt-0 md:w-2/3">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name', $plan->name) }}" required placeholder="e.g. Pro Plan"
                                ...
                                <div class="col-span-6">
                                    ...
                                    <textarea name="description" id="description" rows="3" placeholder="Describe what this plan includes..."
                                        class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6">{{ old('description', $plan->description) }}</textarea>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <div class="mt-2 flex items-center gap-x-3" x-data="{ 
                                            logoName: null, 
                                            logoPreview: '{{ $plan->logo ? Storage::url($plan->logo) : '' }}' 
                                            }">
                                        <div class="relative">
                                            ...
                                            <div class="mt-2" x-show="logoPreview" style="display: {{ $plan->logo ? 'block' : 'none' }};">
                                        ...
                                        <button type="button" class="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                                            ...
                                            {{ $plan->logo ? 'Change Logo' : 'Upload Logo' }}
                                        </button>
                    ...
                    <div class="mt-5 space-y-6 md:mt-0 md:w-2/3">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                ...
                                <input type="text" name="stripe_price_id" id="stripe_price_id" value="{{ old('stripe_price_id', $plan->stripe_price_id) }}" required placeholder="e.g. price_1234567890"
                                    class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6">
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="text" name="stripe_product_id" id="stripe_product_id" value="{{ old('stripe_product_id', $plan->stripe_product_id) }}" placeholder="e.g. prod_1234567890"
                                    class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative mt-2 rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="price" id="price" step="0.01" min="0" value="{{ old('price', $plan->price) }}" required placeholder="0.00"
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="number" name="monthly_credits" id="monthly_credits" min="0" value="{{ old('monthly_credits', $plan->monthly_credits) }}" required placeholder="e.g. 500"
                                    class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6">
                ...
                <div class="flex flex-col md:flex-row gap-6 p-5">
                    ...
                    <div class="mt-5 space-y-6 md:mt-0 md:w-2/3">
                        <div>
                            ...
                            <input type="hidden" name="features" id="features_json">
                        ...
                        <div class="col-span-6">
                            <div class="relative flex gap-x-3">
                                <div class="flex h-6 items-center">
                                    <input id="hidden" name="hidden" type="checkbox" value="1" {{ old('hidden', $plan->hidden) ? 'checked' : '' }}
                                        class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary">
                                </div>
                                <div class="text-sm leading-6">
